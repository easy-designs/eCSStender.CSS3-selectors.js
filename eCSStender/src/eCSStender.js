...
(function(){
   ...
   * @param mixed html
   *  * object - the HTML to test against (used by selector test)
   *  * false - no html to insert (uses the document)
  ...
  eCSStender.isSupported = function( type, what, html, el )
  {
    ...
    else
    {
      ...
      else if ( type == SELECTOR )
      {
        ...
        if ( html !== FALSE ) { body.appendChild( html ) };
